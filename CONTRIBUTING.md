# How to contribute to Cozy Notes?
...
- What is the version of the Cozy Notes app?
...
```
$ git clone github.com/cozy/cozy-notes.git
$ cd cozy-notes
$ git remote add fork git://github.com/yourusername/cozy-notes.git
```
...
Go to https://github.com/yourusername/cozy-notes and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy Notes is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-notes/issues/new
...
[localization]: https://github.com/cozy/cozy-notes/blob/master/README.md#localization
