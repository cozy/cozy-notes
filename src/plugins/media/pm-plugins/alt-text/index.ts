...
import { pluginFactory } from '@atlaskit/editor-core/utils/plugin-state-factory'
import reducer from './reducer'
import { pmHistoryPluginKey } from '@atlaskit/editor-core/plugins/history/pm-history-types'
