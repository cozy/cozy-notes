...
export default {
  ...
  'fabric.editor.createCommentInvalid': 'Коментарі увімкнуто лише для тексту та заголовків',
  ...
  'fabric.editor.filesAndImages.description': 'Додати на сторінку файли та зображення',
  ...
  'fabric.editor.removeColumns': '{0, plural, one {Видалити стовпці} few {Видалити стовпці} many {Видалити стовпці} other {Видалити стовпці}}',
  'fabric.editor.removeRows': '{0, plural, one {Видалити рядки} few {Видалити рядки} many {Видалити рядки} other {Видалити рядки}}',
