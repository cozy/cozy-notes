...
export default {
  ...
  'fabric.editor.createCommentInvalid': 'Die Kommentarfunktion ist nur für Text und Überschriften aktiviert.',
  ...
  'fabric.editor.removeRows': '{0, plural, one {Reihe löschen} other {Reihen löschen}}',
