...
export const ToolTipContent = /*#__PURE__*/React.memo(({
  ...
  return shortcut || description ? /*#__PURE__*/React.createElement(React.Fragment, null, description, shortcut && description && '\u00A0', shortcut && /*#__PURE__*/React.createElement(TooltipShortcut, null, shortcut)) : null;
});
...
const ALL = [toggleOrderedList, toggleBulletList, toggleBold, toggleItalic, toggleUnderline, toggleStrikethrough, toggleCode, setNormalText, toggleHeading1, toggleHeading2, toggleHeading3, toggleHeading4, toggleHeading5, toggleHeading6, toggleBlockQuote, insertNewLine, insertRule, splitCodeBlock, splitListItem, redo, undo, find, escape, enter, shiftEnter];
