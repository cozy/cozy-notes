...
class LinkSearchListItem extends React.PureComponent {
  ...
  renderIcon() {
    ...
    if (iconUrl) {
      return /*#__PURE__*/React.createElement(Icon, null, /*#__PURE__*/React.createElement("img", {
        src: iconUrl
      }));
    }
  ...
  renderWithSpaces(pageAction, dateString, timeSince = '') {
    return /*#__PURE__*/React.createElement(React.Fragment, null, "\xA0 \u2022", /*#__PURE__*/React.createElement("span", {
      className: "link-search-timestamp",
      "data-test-id": "link-search-timestamp"
    }, "\xA0 ", pageAction, " ", dateString, " ", timeSince));
  }
  ...
  renderAbsoluteOrRelativeDate(timeStamp, pageAction) {
    ...
    if (differenceInCalendarDays(timeStamp, Date.now()) < -7) {
      return this.renderWithSpaces(pageActionText, format(timeStamp, 'MMMM DD, YYYY'));
    }

    return this.renderWithSpaces(pageActionText, distanceInWords(timeStamp, Date.now()), intl.formatMessage(messages.timeAgo));
  }
  ...
  render() {
    ...
    }, this.renderIcon(), /*#__PURE__*/React.createElement(NameWrapper, null, /*#__PURE__*/React.createElement(Name, null, item.name), /*#__PURE__*/React.createElement(ContainerName, null, item.container, this.renderTimeStamp())));
  }
