...
const ElementBefore = /*#__PURE__*/ memo(({ icon, title }) =>
  /*#__PURE__*/ React.createElement(
    StyledItemIcon,
    null,
    icon
      ? icon()
      : /*#__PURE__*/ React.createElement(IconFallback, {
          label: title
        })
  )
)
const ItemContent = /*#__PURE__*/ memo(({ title, description, keyshortcut }) =>
  /*#__PURE__*/ React.createElement(
    Tooltip,
    {
      content: description
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        description &&
          /*#__PURE__*/ React.createElement(ItemDescription, null, description)
      )
    )
  )
)
...
`
const MemoizedElementListWithAnalytics = /*#__PURE__*/ memo(
