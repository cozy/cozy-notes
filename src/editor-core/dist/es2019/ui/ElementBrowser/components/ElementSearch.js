...
function ElementSearch({
  ...
  const getTheme = useCallback((theme, props) => {
    const {
      container,
      input
    } = theme(props);
    return {
      container: { ...container,
        ...
        ...(Modes.inline && {
          overflow: 'revert'
        }) // Needed for firefox, inherited property would hide the searchbar.
  ...
  return /*#__PURE__*/React.createElement(Textfield, {
    ...
    onFocus: onFocus,
    onBlur: onBlur,
    elemBeforeInput: /*#__PURE__*/React.createElement(ElementBeforeInput, {
    ...
    elemAfterInput: /*#__PURE__*/React.createElement(ElementAfterInput, {
      "data-testid": "element_search__element_after_input"
    }, /*#__PURE__*/React.createElement(StyledShortcut, null, "\u23CE ", formatMessage(elementAfterInputMessage))),
