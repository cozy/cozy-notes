...
const InsertMenu = ({
  ...
  const render = useCallback(({
    quickInsertState
  }) => /*#__PURE__*/React.createElement(ElementBrowserWrapper, {
  ...
  return /*#__PURE__*/React.createElement(InsertMenuWrapper, {
    itemCount: itemCount
    ...
    render: render
  }), itemCount > 0 && viewMoreItem && /*#__PURE__*/React.createElement(ViewMore, {
    item: viewMoreItem
  }));
};
...
const ViewMore = ({
  ...
  return /*#__PURE__*/React.createElement(ThemeProvider, {
    ...
    onClick: item.action,
    elemBefore: /*#__PURE__*/React.createElement(ItemBefore, null, item.icon()),
