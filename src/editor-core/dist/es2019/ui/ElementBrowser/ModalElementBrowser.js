...
const ModalElementBrowser = props => {
  ...
  const RenderFooter = useCallback(footerProps => /*#__PURE__*/React.createElement(Footer, _extends({}, footerProps, {
    onInsert: () => onInsertItem(selectedItem)
  })), [onInsertItem, selectedItem]); // Since Modal uses stackIndex it's shouldCloseOnEscapePress prop doesn't work.
  ...
  const RenderBody = useCallback(() => /*#__PURE__*/React.createElement(Wrapper, null, /*#__PURE__*/React.createElement(ElementBrowser, {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onKeyDown: onKeyDown
  }, /*#__PURE__*/React.createElement(ModalTransition, null, props.isOpen && /*#__PURE__*/React.createElement(Modal, {
    stackIndex: 1
...
const Footer = ({
  ...
  }, /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement(Actions, null, /*#__PURE__*/React.createElement(ActionItem, null, /*#__PURE__*/React.createElement(Button, {
    appearance: "primary",
    onClick: onInsert,
    testId: "ModalElementBrowser__insert-button"
  }, "Insert")), /*#__PURE__*/React.createElement(ActionItem, null, /*#__PURE__*/React.createElement(Button, {
    appearance: "subtle",
    onClick: onClose,
