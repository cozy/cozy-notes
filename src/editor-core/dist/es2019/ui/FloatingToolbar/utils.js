const getCursorHeightFrom = node =>
  parseFloat(window.getComputedStyle(node, undefined).lineHeight || '')

export const getOffsetParent = (editorViewDom, popupsMountPoint) =>
  popupsMountPoint ? popupsMountPoint.offsetParent : editorViewDom.offsetParent
