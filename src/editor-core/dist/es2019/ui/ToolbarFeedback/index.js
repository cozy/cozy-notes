...
export default class ToolbarFeedback extends PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, 'getFeedbackInfo', () => {
      const isFeedbackInfoAttr = attr =>
        ['product', 'packageVersion', 'packageName', 'labels'].indexOf(attr) >=
        0

      return pickBy(
        (key, value) => isFeedbackInfoAttr(key) && !isNullOrUndefined(value),
        this.props
      )
    })
  ...
  render() {
    ...
    const iconBefore = this.state.jiraIssueCollectorScriptLoading
      ...
      : undefined // JIRA issue collector script is using jQuery internally
    ...
    return this.hasJquery()
      ? /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(ButtonContent, null, 'Feedback')
          ),
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ConfirmationHeader,
                  null,
                  /*#__PURE__*/ React.createElement(ConfirmationImg, {
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  /*#__PURE__*/ React.createElement(
                    'div',
                    null,
                    'You can opt-out for now by turning off the "Atlassian Editor" feature on the Labs page in Bitbucket settings.'
                  ),
                  /*#__PURE__*/ React.createElement(
                    ButtonGroup,
                    null,
