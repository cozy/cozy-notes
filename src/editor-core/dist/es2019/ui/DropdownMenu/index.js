...
export default class DropdownMenuWrapper extends PureComponent {
  ...
  renderItem(item) {
    const { onItemActivated, onMouseEnter, onMouseLeave } = this.props // onClick and value.name are the action indicators in the handlers
    ...
    const dropListItem = /*#__PURE__*/ React.createElement(
      ItemWrapper,
      {
