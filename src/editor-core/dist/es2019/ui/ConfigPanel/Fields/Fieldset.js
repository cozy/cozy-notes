...
class FieldsetField extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, 'setIsAdding', value => {
      this.setState(state => ({ ...state, isAdding: value }))
    })

    _defineProperty(this, 'setCurrentParameters', parameters => {
      this.setState(
        state => ({ ...state, currentParameters: parameters }), // callback required so autosave can be triggered on
  ...
  render() {
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      null,
      error &&
        /*#__PURE__*/ React.createElement(FieldsetError, {
          message: error
        }),
      /*#__PURE__*/ React.createElement(
        FormWrapper,
...
function FieldsetError({ message }) {
  return /*#__PURE__*/ React.createElement(
