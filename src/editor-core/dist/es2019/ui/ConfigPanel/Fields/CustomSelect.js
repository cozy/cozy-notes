...
class CustomSelect extends React.Component {
  ...
  async fetchDefaultValues() {
    ...
    if (field.defaultValue && field.isMultiple) {
      this.setDefaultValue(options.filter(option => field.defaultValue.includes(option.value)));
    }

    if (field.defaultValue && !field.isMultiple) {
      this.setDefaultValue(options.find(option => field.defaultValue === option.value) || []);
    }
  }
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(Field, {
      ...
      fieldProps,
      error
    }) => /*#__PURE__*/React.createElement(Fragment, null, resolver && /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(AsyncCreatableSelect, _extends({}, fieldProps, {
      onChange: value => {
      ...
      loadOptions: searchTerm => resolver(searchTerm, field.defaultValue),
      autoFocus: autoFocus,
      placeholder: placeholder
    })), /*#__PURE__*/React.createElement(FieldMessages, {
      error: error,
      description: description
    })), isMissingResolver && /*#__PURE__*/React.createElement(FieldError, {
      field: field
    })));
  }
