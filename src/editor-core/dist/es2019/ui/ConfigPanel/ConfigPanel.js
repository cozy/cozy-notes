...
class ConfigPanel extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "handleSubmit", async formData => {
      ...
      try {
        const serializedData = await serialize(extensionManifest, formData, fields);
    ...
    _defineProperty(this, "renderBody", (extensionManifest, submitting) => {
      ...
      return errorMessage || !fields ? /*#__PURE__*/React.createElement(ErrorMessage, {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (parameters && parameters !== prevProps.parameters || fields && (!prevProps.fields || fields.length !== prevProps.fields.length)) {
      this.parseParameters(fields, parameters);
    }

    if (fields && (!prevProps.fields || fields.length !== prevProps.fields.length)) {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(Form, {
      ...
      }), this.renderHeader(extensionManifest), this.renderBody(extensionManifest, submitting));
    });
  }
