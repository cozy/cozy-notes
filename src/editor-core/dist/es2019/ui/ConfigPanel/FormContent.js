  ...
  switch (field.type) {
    ...
    case 'fieldset':
      return /*#__PURE__*/React.createElement(Fieldset, {
        ...
        error: parameters === null || parameters === void 0 ? void 0 : (_parameters$errors = parameters.errors) === null || _parameters$errors === void 0 ? void 0 : _parameters$errors[field.name]
      });
...
export default function FormContent({
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, fields.map(field => {
    const {
      name
    } = field;
