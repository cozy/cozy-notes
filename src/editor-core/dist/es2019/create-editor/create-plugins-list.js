...
export function getDefaultPresetOptionsFromEditorProps(props) {
  var _props$performanceTra,
    _props$performanceTra2,
    _props$performanceTra3,
    _props$performanceTra4,
    _props$performanceTra5,
    _props$performanceTra6,
    _props$performanceTra7,
    _props$performanceTra8,
    _props$performanceTra9,
    _props$performanceTra10,
    _props$performanceTra11,
    _props$performanceTra12

  const appearance = props.appearance
  const isMobile = appearance === 'mobile'
  const isFullPage = fullPageCheck(appearance) // TODO: https://product-fabric.atlassian.net/browse/ED-10260
  ...
  const hasInputTracking =
    typeof ((_props$performanceTra = props.performanceTracking) === null ||
    _props$performanceTra === void 0
      ? void 0
      : _props$performanceTra.inputTracking) !== 'undefined'
  inputTracking.countNodes =
    !hasInputTracking && shouldForceTracking() ? true : inputTracking.countNodes
  const forceBFreezeTracking =
    typeof ((_props$performanceTra2 = props.performanceTracking) === null ||
    _props$performanceTra2 === void 0
      ? void 0
      : _props$performanceTra2.bFreezeTracking) === 'undefined' &&
    shouldForceTracking()
  const bFreezeTracking = {
    trackInteractionType:
      !!forceBFreezeTracking ||
      !!((_props$performanceTra3 = props.performanceTracking) === null ||
      _props$performanceTra3 === void 0
        ? void 0
        : (_props$performanceTra4 = _props$performanceTra3.bFreezeTracking) ===
            null || _props$performanceTra4 === void 0
        ? void 0
        : _props$performanceTra4.trackInteractionType),
    trackSeverity:
      !!forceBFreezeTracking ||
      !!((_props$performanceTra5 = props.performanceTracking) === null ||
      _props$performanceTra5 === void 0
        ? void 0
        : (_props$performanceTra6 = _props$performanceTra5.bFreezeTracking) ===
            null || _props$performanceTra6 === void 0
        ? void 0
        : _props$performanceTra6.trackSeverity),
    severityNormalThreshold:
      (_props$performanceTra7 =
        (_props$performanceTra8 = props.performanceTracking) === null ||
        _props$performanceTra8 === void 0
          ? void 0
          : (_props$performanceTra9 =
              _props$performanceTra8.bFreezeTracking) === null ||
            _props$performanceTra9 === void 0
          ? void 0
          : _props$performanceTra9.severityNormalThreshold) !== null &&
      _props$performanceTra7 !== void 0
        ? _props$performanceTra7
        : NORMAL_SEVERITY_THRESHOLD,
    severityDegradedThreshold:
      (_props$performanceTra10 =
        (_props$performanceTra11 = props.performanceTracking) === null ||
        _props$performanceTra11 === void 0
          ? void 0
          : (_props$performanceTra12 =
              _props$performanceTra11.bFreezeTracking) === null ||
            _props$performanceTra12 === void 0
          ? void 0
          : _props$performanceTra12.severityDegradedThreshold) !== null &&
      _props$performanceTra10 !== void 0
        ? _props$performanceTra10
        : DEGRADED_SEVERITY_THRESHOLD
...
export default function createPluginsList(
  ...
  if (props.collabEdit || props.collabEditProvider) {
    ...
    if (props.collabEdit) {
      collabEditOptions = { ...props.collabEdit, ...collabEditOptions }
    }
