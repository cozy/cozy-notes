...
export const createDecorations = (selectedIndex, matches) =>
...
export const prevIndex = (currentIndex, total) =>
...
export const removeDecorationsFromSet = (
  ...
  decorationSet = decorationSet.remove(
    decorationsToRemove.map((
      decoration // copy exists but isn't on the type definition
