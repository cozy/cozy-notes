...
class FindReplaceToolbarButton extends React.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(ToolbarButtonWrapper, null, /*#__PURE__*/React.createElement(Dropdown, {
    ...
    }, /*#__PURE__*/React.createElement(Wrapper, null, /*#__PURE__*/React.createElement(FindReplace, _extends({
      findText: findText,
