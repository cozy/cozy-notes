...
export const findReplacePlugin = () => {
  return {
    ...
    primaryToolbarComponent({
      ...
      const handleFindNext = ({ triggerMethod }) => {
        runWithEditorFocused(() =>
          dispatchCommand(
            findNextWithAnalytics({
              triggerMethod
      ...
      const handleFindPrev = ({ triggerMethod }) => {
        runWithEditorFocused(() =>
          dispatchCommand(
            findPrevWithAnalytics({
              triggerMethod
      ...
      const handleReplace = ({ triggerMethod, replaceText }) => {
        runWithEditorFocused(() =>
          dispatchCommand(
            replaceWithAnalytics({
              triggerMethod,
      ...
      const handleReplaceAll = ({ replaceText }) => {
        runWithEditorFocused(() =>
          dispatchCommand(
            replaceAllWithAnalytics({
              replaceText
      ...
      const handleCancel = ({ triggerMethod }) => {
        dispatchCommand(
          cancelSearchWithAnalytics({
            triggerMethod
          })
