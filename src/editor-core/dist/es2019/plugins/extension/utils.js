...
export const getSelectedNonContentExtension = ({ schema, selection }) => {
...
export const getSelectedDomElement = (
  ...
  isContentExtension = false
) => {
  const selectedExtensionDomNode =
    selectedExtensionNode &&
    findDomRefAtPos(selectedExtensionNode.pos, domAtPos) // Non-content extension can be nested in bodied-extension, the following check is necessary for that case
