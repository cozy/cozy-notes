...
export default class ExtensionLozenge extends Component {
  ...
  renderFallback(lozengeData) {
    ...
    return /*#__PURE__*/React.createElement(PlaceholderFallback, null, lozengeData && !isBlockExtension ? this.renderImage({
      height: ICON_SIZE,
      width: ICON_SIZE,
      ...lozengeData
    ...
    }, capitalizeFirstLetter(title)), params && !isBlockExtension && /*#__PURE__*/React.createElement(PlaceholderFallbackParams, null, Object.keys(params).map(key => key && ` | ${key} = ${params[key].value}`)));
  }
