...
export class LinkToolbarAppearance extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "renderDropdown", (view, cardContext) => {
      ...
      const isDropdownDisabled = currentAppearance === 'inline' && !isSupportedInParent(editorState, Fragment.from(editorState.schema.nodes.blockCard.createChecked({})));
      ...
      return /*#__PURE__*/React.createElement(Dropdown, {
        ...
        tooltip: isDropdownDisabled ? parentNodeName(editorState, intl) : undefined
      });
    });
  }
