...
import { UnsupportedBlock, MediaSingle as RichMediaWrapper, browser, findOverflowScrollParent } from '@atlaskit/editor-common';
...
export class EmbedCardComponent extends React.PureComponent {
  ...
  render() {
    ...
    const cardInner = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(WithPluginState, {
      editorView: view,
      plugins: {
      ...
      render: ({
        ...
        const lineLength = this.getLineLength(view, pos, widthState && widthState.lineLength);
        const containerWidth = isRichMediaInsideOfBlockNode(view, pos) ? lineLength : widthState.width;
