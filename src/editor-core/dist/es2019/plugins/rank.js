export default {
  plugins: [
    ...
    'textFormattingClear',
    'textFormattingKeymap', // task/decisions keymap needs to be above table keymap so can indent actions in a table
    ...
    'tableKeymap', // selection keymap needs to be above gap cursor keymap so it can set node selections from
    // left/right arrows
    'selectionKeymap',
    'gapCursorKeymap',
    'gapCursor',
  ...
  marks: [
    ...
    'underline',
    'code',
    'typeAheadQuery', // Block marks
    'alignment',
    'breakout',
    'indentation',
    'annotation', //Unsupported mark
    'unsupportedMark',
