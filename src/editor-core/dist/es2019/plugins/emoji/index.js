    ...
    quickInsert: ({ formatMessage }) => [
      {
        ...
        keyshortcut: ':',
        icon: () =>
          /*#__PURE__*/ React.createElement(IconEmoji, {
      ...
      apply(tr, pluginState) {
        ...
        switch (action) {
          case ACTIONS.SET_PROVIDER:
            newPluginState = { ...pluginState, emojiProvider: params.provider }
            dispatch(emojiPluginKey, newPluginState)
            return newPluginState

          case ACTIONS.SET_RESULTS:
            newPluginState = { ...pluginState, emojis: params.results.emojis }
            dispatch(emojiPluginKey, newPluginState)
            return newPluginState
        }
