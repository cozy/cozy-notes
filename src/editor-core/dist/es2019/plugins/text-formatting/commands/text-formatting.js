  ...
  return (state, dispatch) => {
    ...
    if (code) {
      ...
      const enteringCode =
        !currentPosHasCode &&
        nextPosHasCode &&
        (!storedMarks || !storedMarks.length) // entering code mark (from the left edge): don't move the cursor, just add the mark
  ...
  return (state, dispatch) => {
    ...
    if (code) {
      ...
      const enteringCode =
        ...
        !storedMarks.length // at the right edge: remove code mark and move the cursor to the left
