...
import { toggleEmWithAnalytics, toggleStrongWithAnalytics } from '../../commands/text-formatting';
...
class ToolbarTextFormatting extends PureComponent {
  ...
  render() {
    ...
    }, strongHidden ? null : /*#__PURE__*/React.createElement(ToolbarButton, {
    ...
    }), emHidden ? null : /*#__PURE__*/React.createElement(ToolbarButton, {
      spacing: isReducedSpacing ? 'none' : 'default',
