...
export class AltTextEditComponent extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(Container, null, /*#__PURE__*/React.createElement(InputWrapper, null, /*#__PURE__*/React.createElement(ButtonWrapper, null, /*#__PURE__*/React.createElement(Button, {
      ...
      autoFocus: true
    }), showClearTextButton && /*#__PURE__*/React.createElement(ButtonWrapper, null, /*#__PURE__*/React.createElement(Button, {
      testId: "alt-text-clear-button",
      title: formatMessage(messages.clear),
      icon: /*#__PURE__*/React.createElement(ClearText, null, /*#__PURE__*/React.createElement(CrossCircleIcon, {
