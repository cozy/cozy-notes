...
const mediaPlugin = options => ({
  ...
  nodes() {
    ...
    const mediaSingleNode = UNSAFE_allowImageCaptions ? mediaSingleWithCaption : mediaSingle;
    return [{
      name: 'mediaGroup',
      node: mediaGroup
    }, {
  ...
  pmPlugins() {
    ...
    if (options && options.allowAnnotation) {
      pmPlugins.push({
        name: 'mediaEditor',
        plugin: createMediaEditorPlugin
      });
    }
  ...
  contentComponent({
    ...
    const mediaEditor = options && options.allowAnnotation ? /*#__PURE__*/React.createElement(WithPluginState, {
      editorView: editorView,
      plugins: {
        mediaEditorState: mediaEditorPluginKey
      },
      eventDispatcher: eventDispatcher,
      render: ({
        mediaEditorState
      }) => /*#__PURE__*/React.createElement(MediaEditor, {
  ...
  pluginsOptions: {
    quickInsert: ({
      ...
      icon: () => /*#__PURE__*/React.createElement(IconImages, {
        label: formatMessage(messages.filesAndImages)
      }),
