...
export default class PickerFacade {
  constructor(pickerType, config, pickerConfig, mediaPickerFactoryClass = MediaPicker, analyticsName) {
  ...
  async init() {
    ...
    if (this.pickerType === 'customMediaPicker') {
      ...
      picker = this.picker = await this.mediaPickerFactoryClass(this.config.mediaClientConfig, this.pickerConfig);
    }
