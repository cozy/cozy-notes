...
export const openMediaEditor = (pos, identifier) =>
  createCommand({
    type: 'open',
    identifier,
    pos
...
export const setMediaClientConfig = mediaClientConfig =>
  createCommand({
    type: 'setMediaClientConfig',
    mediaClientConfig
  })
export const uploadAnnotation = (newIdentifier, newDimensions) =>
  createCommand(
    {
      type: 'upload',
      newIdentifier
