...
export class AnnotationToolbar extends React.Component {
  ...
  async checkIsImage() {
    ...
    } catch (err) {// do nothing in case of media-client error
    }
  }
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Separator, null), /*#__PURE__*/React.createElement(Button, {
      title: title,
