  ...
  pmPlugins() {
    const plugins = [{
      ...
      plugin: ({
        ...
        return options && options.inputTracking && options.inputTracking.enabled ? frozenEditor(dispatchAnalyticsEvent, options.inputTracking, options.bFreezeTracking) : undefined;
      }
    }, {
