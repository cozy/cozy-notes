...
const dispatchLongTaskEvent = (
  ...
  return dispatchAnalyticsEvent({
    ...
    attributes: {
      objectId:
        (_getContextIdentifier = getContextIdentifier(state)) === null ||
        _getContextIdentifier === void 0
          ? void 0
...
export default (
  ...
  if (
    browserFreezeTracking === null || browserFreezeTracking === void 0
      ? void 0
  ...
  return new Plugin({
    props: isPerformanceAPIAvailable()
      ? {
              ...
              if (samplingRate && ++keystrokeCount === samplingRate) {
                ...
                dispatchAnalyticsEvent({
                  ...
                  attributes: {
                    ...
                    objectId:
                      (_getContextIdentifier2 = getContextIdentifier(state)) ===
                        null || _getContextIdentifier2 === void 0
                        ? void 0
                        : _getContextIdentifier2.objectId
                  },
                  eventType: EVENT_TYPE.OPERATIONAL
                })
              }
              ...
              if (diff > slowThreshold) {
                ...
                dispatchAnalyticsEvent({
                  ...
                  attributes: {
                    ...
                    participants: getParticipantsCount(state),
                    objectId:
                      (_getContextIdentifier3 = getContextIdentifier(state)) ===
                        null || _getContextIdentifier3 === void 0
                        ? void 0
                        : _getContextIdentifier3.objectId
                  },
                  eventType: EVENT_TYPE.OPERATIONAL
                })
              }
          ...
          handleDOMEvents: (browserFreezeTracking === null ||
          browserFreezeTracking === void 0
          ? void 0
          : browserFreezeTracking.trackInteractionType)
            ? {
                click: () => {
