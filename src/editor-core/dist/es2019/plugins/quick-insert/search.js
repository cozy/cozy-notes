import Fuse from 'fuse.js' // AFP-2532 TODO: Fix automatic suppressions below
...
export const searchQuickInsertItems = (quickInsertState, options) => (
  query,
  category
) => {
  const defaultItems =
...
export const getFeaturedQuickInsertItems = (
  { providedItems, lazyDefaultItems },
  options
) => () => {
  const defaultItems =
