  ...
  constructor(...args) {
    ...
    _defineProperty(this, 'changeTextColor', (color, disabled) => {
      if (!disabled) {
        ...
        const { isShowingMoreColors } = this.state // we store color names in analytics
    ...
    _defineProperty(this, 'handleOpenChange', ({ isOpen, logCloseEvent }) => {
      const {
        pluginState: { palette, color }
      } = this.props
      const { isShowingMoreColors } = this.state // pre-expand if a non-standard colour has been selected

      const isExtendedPaletteSelected = !palette.find(
          ...
          trigger: /*#__PURE__*/ React.createElement(ToolbarButton, {
            ...
            iconBefore: /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                TextColorIconWrapper,
                null,
                /*#__PURE__*/ React.createElement(EditorTextColorIcon, null),
                /*#__PURE__*/ React.createElement(TextColorIconBar, {
                  selectedColor:
                    pluginState.color !== pluginState.defaultColor &&
                    pluginState.color,
                  gradientColors: pluginState.disabled
                    ? disabledRainbow
                    : rainbow
                })
              ),
