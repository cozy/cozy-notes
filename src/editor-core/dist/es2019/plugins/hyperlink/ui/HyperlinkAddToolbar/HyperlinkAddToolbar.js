...
export class HyperlinkLinkAddToolbar extends PureComponent {
  ...
  constructor(props) {
    ...
    _defineProperty(
      this,
      'quickSearch',
      async (input, items, quickSearchLimit) => {
        ...
        this.fireAnalytics({
          ...
          attributes: {
            ...
            searchSessionId:
              (_pluginState$searchSe = pluginState.searchSessionId) !== null &&
              _pluginState$searchSe !== void 0
                ? _pluginState$searchSe
                : '',
        ...
        try {
          ...
          const searchItems = limit(
            filterUniqueItems(
              ...
              (firstItem, secondItem) =>
                firstItem.objectId === secondItem.objectId
            )
          )
          ...
          this.fireAnalytics({
            ...
            attributes: {
              ...
              searchSessionId:
                (_pluginState$searchSe2 = pluginState.searchSessionId) !==
                  null && _pluginState$searchSe2 !== void 0
                  ? _pluginState$searchSe2
                  : '',
    ...
    _defineProperty(
      this,
      'handleInsert',
      (href, title, inputType, interaction) => {
        ...
        this.fireAnalytics({
          ...
          attributes: {
            source: this.analyticSource,
            searchSessionId:
              (_pluginState$searchSe3 = pluginState.searchSessionId) !== null &&
              _pluginState$searchSe3 !== void 0
                ? _pluginState$searchSe3
                : '',
            trigger: interaction,
    ...
    _defineProperty(this, 'handleSubmit', () => {
      const { items, displayUrl, selectedIndex } = this.state // add the link selected in the dropdown if there is one, otherwise submit the value of the input field
      ...
      if (items[updatedIndex]) {
        ...
        this.fireAnalytics({
          ...
          attributes: {
            source: this.analyticSource,
            searchSessionId:
              (_pluginState$searchSe4 = pluginState.searchSessionId) !== null &&
              _pluginState$searchSe4 !== void 0
                ? _pluginState$searchSe4
                : '',
  ...
  async componentDidMount() {
    ...
    this.fireAnalytics({
      ...
      attributes: {
        ...
        searchSessionId:
          (_pluginState$searchSe5 = pluginState.searchSessionId) !== null &&
          _pluginState$searchSe5 !== void 0
            ? _pluginState$searchSe5
            : '',
        trigger:
          (_pluginState$inputMet = pluginState.inputMethod) !== null &&
          _pluginState$inputMet !== void 0
    ...
    if (!this.submitted) {
      ...
      this.fireAnalytics({
        ...
        attributes: {
          source: this.analyticSource,
          searchSessionId:
            (_pluginState$searchSe6 = pluginState.searchSessionId) !== null &&
            _pluginState$searchSe6 !== void 0
              ? _pluginState$searchSe6
              : '',
          trigger: 'blur'
        },
        eventType: EVENT_TYPE.UI
    ...
    try {
      ...
      this.fireAnalytics({
        ...
        attributes: {
          ...
          searchSessionId:
            (_pluginState$searchSe7 = pluginState.searchSessionId) !== null &&
            _pluginState$searchSe7 !== void 0
              ? _pluginState$searchSe7
              : '',
          resultCount: items.length,
