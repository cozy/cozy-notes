...
export function indentList(inputMethod = INPUT_METHOD.KEYBOARD) {
  return function (state, dispatch) {
    ...
    } = state; // don't indent if selection is not inside a list
    ...
    if (firstListItemSelectedAttributes && firstListItemSelectedAttributes.indentLevel === 0 && firstListItemSelectedAttributes.itemIndex === 0) {
