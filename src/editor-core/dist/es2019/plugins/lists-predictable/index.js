...
const listPlugin = () => ({
  ...
  pluginsOptions: {
    quickInsert: ({
      ...
      icon: () => /*#__PURE__*/React.createElement(IconListNumber, {
  ...
  primaryToolbarComponent({
    ...
    return /*#__PURE__*/React.createElement(WithPluginState, {
      plugins: {
        listsState: pluginKey
      },
      render: ({
        listsState
      }) => /*#__PURE__*/React.createElement(ToolbarLists, {
        isSmall: isSmall,
