...
import { Fragment, Slice } from 'prosemirror-model'; // adapted from https://github.com/ProseMirror/prosemirror-schema-list/blob/master/src/schema-list.js#L206:L231
...
export const indentList = tr => {
  ...
  const parent = range.parent; // get the list immediately before the selection start
