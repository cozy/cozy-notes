...
export const joinListItemWithParagraph = ({ tr, $next, $head }) => {
  ...
  const insertions = []
  const deletions = [] // For lists that only have one list item with no children - need to remove remaining list
