...
export const getNextSiblingListItemPosition = $pos => {
  ...
  const listItemNodePosition =
    ((_$pos$doc$nodeAt = $pos.doc.nodeAt(listItemPosition)) === null ||
    _$pos$doc$nodeAt === void 0
      ? void 0
      : _$pos$doc$nodeAt.nodeSize) || 0
...
export const hasValidListIndentationLevel = ({ tr, maxIndentation }) => {
