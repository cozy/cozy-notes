...
class FloatingContextualButton extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleClick", () => {
      const {
        state,
        dispatch
      } = this.props.editorView; // Clicking outside the dropdown handles toggling the menu closed
  ...
  render() {
    ...
    const button = /*#__PURE__*/React.createElement(ButtonWrapper, null, /*#__PURE__*/React.createElement(ToolbarButton, {
...
_defineProperty(FloatingContextualButton, "displayName", 'FloatingContextualButton');
