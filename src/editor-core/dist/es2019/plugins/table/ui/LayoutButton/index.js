...
class LayoutButton extends React.Component {
  ...
  shouldComponentUpdate(nextProps) {
    return this.props.targetRef !== nextProps.targetRef || this.props.layout !== nextProps.layout || this.props.isResizing !== nextProps.isResizing;
  }
