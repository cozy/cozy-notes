...
export default class TableFloatingControls extends Component {
  constructor(...args) {
    ...
    _defineProperty(this, "selectRow", (row, expand) => {
      ...
      const {
        state,
        dispatch
      } = editorView; // fix for issue ED-4665
  ...
  shouldComponentUpdate(nextProps) {
    ...
    return ordering !== nextProps.ordering || tableRef !== nextProps.tableRef || tableHeight !== nextProps.tableHeight || tableActive !== nextProps.tableActive || isInDanger !== nextProps.isInDanger || isResizing !== nextProps.isResizing || hoveredRows !== nextProps.hoveredRows || isHeaderRowEnabled !== nextProps.isHeaderRowEnabled || isHeaderColumnEnabled !== nextProps.isHeaderColumnEnabled || isNumberColumnEnabled !== nextProps.isNumberColumnEnabled || isSelectionUpdated(selection, nextProps.selection) || headerRowHeight !== nextProps.headerRowHeight || stickyHeader !== nextProps.stickyHeader;
  }
  ...
  render() {
    ...
    const stickyTop = stickyHeader && stickyHeader.sticky ? stickyHeader.top : undefined;
    return /*#__PURE__*/React.createElement("div", {
      ...
      stickyTop: stickyTop
    }) : null, /*#__PURE__*/React.createElement(CornerControls, {
      editorView: editorView,
      tableRef: tableRef,
      isInDanger: isInDanger,
      isResizing: isResizing,
