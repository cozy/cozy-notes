...
export const isCornerButton = node =>
  containsClassName(node, ClassName.CONTROLS_CORNER_BUTTON)
export const isInsertRowButton = node =>
...
export const hasResizeHandler = ({ columnEndIndexTarget, target }) => {
