...
export const findColumnControlSelectedDecoration = decorationSet =>
  filterDecorationByKey(TableDecorations.COLUMN_SELECTED, decorationSet)
export const findControlsHoverDecoration = decorationSet =>
  filterDecorationByKey(TableDecorations.ALL_CONTROLS_HOVER, decorationSet)
export const createCellHoverDecoration = (cells, type) =>
  cells.map(cell =>
    Decoration.node(
      cell.pos,
...
export const createControlsHoverDecoration = (cells, type, danger) =>
  cells.map(cell => {
...
export const createColumnControlsDecoration = selection => {
  ...
  return cells.map(cell => {
    ...
    return Decoration.widget(
      cell.pos + 1, // Do not delay the rendering for this Decoration
