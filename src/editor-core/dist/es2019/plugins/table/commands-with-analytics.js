...
export const setColorWithAnalytics = (cellColor, targetCellPosition) =>
  withAnalytics(({ selection }) => {
    const {
      horizontalCells,
      verticalCells,
...
export const insertRowWithAnalytics = (inputMethod, options) =>
  withAnalytics(state => {
...
export const insertColumnWithAnalytics = (inputMethod, position) =>
  withAnalytics(state => {
    const { totalRowCount, totalColumnCount } = getSelectedTableInfo(
      state.selection
    )
...
export const deleteColumnsWithAnalytics = (inputMethod, rect) =>
  withAnalytics(({ selection }) => {
    const { totalRowCount, totalColumnCount } = getSelectedTableInfo(selection)
    return {
...
export const deleteTableIfSelectedWithAnalytics = inputMethod =>
  withAnalytics(({ selection }) =>
...
export const sortColumnWithAnalytics = (inputMethod, columnIndex, sortOrder) =>
  withAnalytics(state => {
    const { totalRowCount, totalColumnCount } = getSelectedTableInfo(
      state.selection
    )
