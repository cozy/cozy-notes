...
const selectFullTable = ({
  ...
  return setSelectionRelativeToNode(selectionRelativeToNode, fullTableSelection)(state, dispatch);
};
...
const setSelectionAtStartOfFirstCell = (selection, selectionRelativeToNode) => (state, dispatch) => {
  ...
  return setSelectionRelativeToNode(selectionRelativeToNode, selectionAtStartOfCell)(state, dispatch);
};
...
const setSelectionAtEndOfLastCell = (selection, selectionRelativeToNode) => (state, dispatch) => {
  ...
  return setSelectionRelativeToNode(selectionRelativeToNode, selectionAtEndOfCell)(state, dispatch);
};
...
const setGapCursorBeforeTable = () => (state, dispatch) => {
  ...
  if (table) {
    ...
    if (GapCursorSelection.valid($beforeTablePos)) {
      ...
      return setSelectionRelativeToNode(undefined, selectionBeforeTable)(state, dispatch);
    }
  }
...
const setGapCursorAfterTable = () => (state, dispatch) => {
  ...
  if (table) {
    ...
    if (GapCursorSelection.valid($afterTablePos)) {
      ...
      return setSelectionRelativeToNode(undefined, selectionAfterTable)(state, dispatch);
    }
  }
