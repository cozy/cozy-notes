...
export const hoverColumns = (hoveredColumns, isInDanger) =>
  createCommand(
    state => {
...
export const hoverRows = (hoveredRows, isInDanger) =>
  createCommand(
    state => {
...
export const hoverTable = isInDanger =>
  createCommand(
    state => {
...
export const showResizeHandleLine = cellColumnPositioning =>
  createCommand(state => ({
