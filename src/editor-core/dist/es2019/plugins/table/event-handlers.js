...
export const handleMouseOver = (view, mouseEvent) => {
  ...
  if (isInsertRowButton(target)) {
    ...
    const positionRow =
      getMousePositionVerticalRelativeByElement(mouseEvent) === 'bottom'
        ? endIndex
        : startIndex
...
export const handleMouseMove = (view, event) => {
  ...
  if (isColumnControlsDecorations(element)) {
    ...
    const positionColumn =
      getMousePositionHorizontalRelativeByElement(event) === 'right'
        ? endIndex
        : startIndex
