...
export class TableRowNodeView {
  constructor(node, view, getPos, eventDispatcher) {
    ...
    _defineProperty(this, "shouldHeaderStick", tree => {
      ...
      const bottomVisible = scrollTop - wrapperRect.bottom < this.dom.clientHeight;
      return refTop <= scrollTop && bottomVisible && firstHeaderRow && subsequentRows;
    });
    ...
    _defineProperty(this, "makeHeaderRowSticky", tree => {
      ...
      const domTop = this.getCurrentTableTop(tree) > 0 ? this.scrollElementTop : this.scrollElementTop + this.getCurrentTableTop(tree);
    ...
    _defineProperty(this, "getScrolledTableTop", wrapper => this.getWrapperRefTop(wrapper) - this.scrollElementTop);
