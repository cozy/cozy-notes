...
const createTableWithAnalytics = () => withAnalytics({
...
export function keymapPlugin() {
  ...
  keymaps.bindKeymapWithCommand(keymaps.backspace.common, chainCommands(deleteTableIfSelectedWithAnalytics(INPUT_METHOD.KEYBOARD), emptyMultipleCellsWithAnalytics(INPUT_METHOD.KEYBOARD)), list);
