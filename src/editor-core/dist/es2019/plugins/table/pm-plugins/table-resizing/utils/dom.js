...
export const updateControls = state => {
  ...
  const rowControls = wrapper.parentElement.querySelectorAll(
  ...
  const rightShadows = wrapper.parentElement.querySelectorAll(
    `.${ClassName.TABLE_RIGHT_SHADOW}`
  )
  const leftShadows = wrapper.parentElement.querySelectorAll(
