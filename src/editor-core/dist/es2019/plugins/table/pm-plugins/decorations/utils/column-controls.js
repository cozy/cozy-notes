...
const isColumnSelected = tr =>
  tr.selection instanceof CellSelection && tr.selection.isColSelection() // @see: https://product-fabric.atlassian.net/browse/ED-3796
...
const removeColumnControlsSelectedDecoration = ({ decorationSet }) =>
  decorationSet.remove(findColumnControlSelectedDecoration(decorationSet))

const hasColumnSelectedDecorations = decorationSet =>
...
export const buildColumnControlsDecorations = ({ decorationSet, tr }) => {
