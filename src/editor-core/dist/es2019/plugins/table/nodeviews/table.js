...
export default class TableView extends ReactNodeView {
  ...
  render(props, forwardRef) {
    return /*#__PURE__*/React.createElement(WithPluginState, {
      ...
      render: pluginStates => /*#__PURE__*/React.createElement(TableComponent, _extends({}, props, pluginStates, {
        node: this.node,
...
export const createTableView = (node, view, getPos, portalProviderAPI, eventDispatcher, options) => {
  const {
    pluginConfig
