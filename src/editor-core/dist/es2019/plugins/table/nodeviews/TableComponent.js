...
import { browser, calcTableWidth, tableMarginSides } from '@atlaskit/editor-common';
...
const FloatingPlaceholder = () => /*#__PURE__*/React.createElement("div", {
  style: {
    position: 'absolute',
    top: '30px'
  }
...
class TableComponent extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "scaleTable", scaleOptions => {
      ...
      scaleTable(this.table, { ...scaleOptions,
        node,
  ...
  componentDidUpdate(prevProps) {
    if (this.wrapper && this.wrapper.parentElement) {
      const rightShadows = this.wrapper.parentElement.querySelectorAll(`.${ClassName.TABLE_RIGHT_SHADOW}`);
      const leftShadows = this.wrapper.parentElement.querySelectorAll(`.${ClassName.TABLE_LEFT_SHADOW}`);
    ...
    if (this.props.node.attrs.__autoSize) {
      ...
      // re-draw colgroup.
      if (tablesHaveDifferentColumnWidths(this.props.node, prevProps.node) || tablesHaveDifferentNoOfColumns(this.props.node, prevProps.node)) {
        const {
          view
        } = this.props;
  ...
  render() {
    ...
    const shadowPadding = allowControls && !isLoading && tableActive ? -tableToolbarSize : tableMarginSides;
    ...
    }, /*#__PURE__*/React.createElement(FloatingPlaceholder, null), allowControls && !isLoading && rowControls, /*#__PURE__*/React.createElement("div", {
