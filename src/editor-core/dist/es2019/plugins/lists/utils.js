...
export const isPosInsideList = $pos => {
  ...
  return posParentTypeName === 'listItem' || posParentTypeName === 'orderedList' || posParentTypeName === 'bulletList' || posGrandParent && posGrandParent.type.name === 'listItem';
};
