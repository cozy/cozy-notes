...
export const calcJoinListScenario = (walkNode, $head, tr) => {
  ...
  const prevParentLastChildIsParagraph =
    $prev.parent.lastChild && $prev.parent.lastChild.type.name === 'paragraph' // Will search for the possible last node for case 4 (where the list could be indented multiple times)
