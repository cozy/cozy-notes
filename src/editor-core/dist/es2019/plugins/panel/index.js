...
const insertPanelTypeWithAnalytics = (panelType, state, insert) => {
...
const insertPanelType = (panelType, state) => state.schema.nodes.panel.createChecked({
  panelType
...
const panelPlugin = (options = {}) => ({
  ...
  pluginsOptions: {
    quickInsert: ({
      ...
      priority: 800,
      icon: () => /*#__PURE__*/React.createElement(IconPanel, {
        label: formatMessage(messages.infoPanel)
      }),
      ...
      priority: 1000,
      icon: () => /*#__PURE__*/React.createElement(IconPanelNote, {
        label: formatMessage(messages.notePanel)
      }),
      ...
      keywords: ['tip'],
      priority: 1000,
      icon: () => /*#__PURE__*/React.createElement(IconPanelSuccess, {
        label: formatMessage(messages.successPanel)
      }),
      ...
      priority: 1000,
      icon: () => /*#__PURE__*/React.createElement(IconPanelWarning, {
        label: formatMessage(messages.warningPanel)
      }),
      ...
      priority: 1000,
      icon: () => /*#__PURE__*/React.createElement(IconPanelError, {
        label: formatMessage(messages.errorPanel)
      }),
