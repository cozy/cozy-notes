...
export const setPluginState = stateProps => (state, dispatch) => {
  ...
  if (dispatch) {
    dispatch(state.tr.setMeta(pluginKey, { ...pluginState, ...stateProps }))
  }
      ...
      return {
        update: view => {
          ...
          const panelRef = panelNode
            ? findDomRefAtPos(panelNode.pos, domAtPos)
            : undefined
          ...
          if (panelRef !== pluginState.element) {
            const newState = {
              ...
              activePanelType:
                panelRef &&
                (panelNode === null || panelNode === void 0
                  ? void 0
                  : panelNode.node.attrs['panelType']),
              ...
              activePanelIcon: pluginOptions.UNSAFE_allowCustomPanel
                ? panelRef &&
                  (panelNode === null || panelNode === void 0
                    ? void 0
                    : panelNode.node.attrs['panelIcon'])
                : undefined,
