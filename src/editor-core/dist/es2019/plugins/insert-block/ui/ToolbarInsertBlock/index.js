...
import { ACTION, ACTION_SUBJECT, ACTION_SUBJECT_ID, EVENT_TYPE, INPUT_METHOD, withAnalytics as commandWithAnalytics } from '../../../analytics';
...
class ToolbarInsertBlock extends React.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "toDropdownItems", memoizeOne(items => [{
      items
    }]));
    ...
    _defineProperty(this, "insertTaskDecision", (name, inputMethod) => () => {
      ...
      insertTaskDecision(editorView, listType, inputMethod)(editorView.state, editorView.dispatch);
      return true;
    });
    ...
    _defineProperty(this, "insertHorizontalRule", inputMethod => {
      ...
      const tr = createHorizontalRule(editorView.state, editorView.state.selection.from, editorView.state.selection.to, inputMethod);
  ...
  getElementBrowserForInsertMenu() {
    ...
    const dropDownLabel = formatMessage(messages.insertMenu);
    const spacing = isReducedSpacing ? 'none' : 'default';
    return /*#__PURE__*/React.createElement(React.Fragment, null, isPlusMenuOpen && /*#__PURE__*/React.createElement(Popup, {
  ...
  renderInsertMenu() {
    ...
    return replacePlusMenuWithElementBrowser ? this.getElementBrowserForInsertMenu() : this.getLegacyInsertMenu();
  }
  ...
  render() {
    ...
    }, buttons.map(btn => /*#__PURE__*/React.createElement(ToolbarButton, {
      item: btn,
    ...
    })), /*#__PURE__*/React.createElement(Wrapper, null, this.renderPopup(), this.renderInsertMenu()), this.props.showSeparator && /*#__PURE__*/React.createElement(Separator, null));
  }
