  ...
  pmPlugins() {
    return [{
      ...
      plugin: ({
        ...
        return createPlugin(dispatch, reactContext, options.useLongPressSelection);
      }
    }, {
      name: 'expandKeymap',
      plugin: expandKeymap
  ...
  pluginsOptions: {
    ...
    quickInsert: ({
      ...
      return [{
        ...
        priority: 600,
        icon: () => /*#__PURE__*/React.createElement(IconExpand, {
          label: formatMessage(messages.expand)
        }),
