...
export const formatting = ({
  ...
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeLg, null, "**", /*#__PURE__*/React.createElement(FormattedMessage, textFormattingMessages.bold), "**"))
}, {
  name: formatMessage(textFormattingMessages.italic),
  type: 'em',
  keymap: () => keymaps.toggleItalic,
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeLg, null, "*", /*#__PURE__*/React.createElement(FormattedMessage, textFormattingMessages.italic), "*"))
}, {
  ...
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeLg, null, "~~", /*#__PURE__*/React.createElement(FormattedMessage, advancedTextFormattingMessages.strike), "~~"))
}, {
  name: formatMessage(blockTypeMessages.heading1),
  type: 'heading',
  keymap: () => keymaps.toggleHeading1,
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeSm, null, "#"), " ", /*#__PURE__*/React.createElement(CodeLg, null, "Space"))
}, {
  name: formatMessage(blockTypeMessages.heading2),
  type: 'heading',
  keymap: () => keymaps.toggleHeading2,
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeLg, null, "##"), " ", /*#__PURE__*/React.createElement(CodeLg, null, "Space"))
}, {
  ...
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeSm, null, "1."), " ", /*#__PURE__*/React.createElement(CodeLg, null, "Space"))
}, {
  ...
  type: 'codeBlock',
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeLg, null, "```"))
}, {
  ...
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeLg, null, "[", /*#__PURE__*/React.createElement(FormattedMessage, insertBlockMessages.link), "](http://a.com)"))
}, {
  name: formatMessage(advancedTextFormattingMessages.code),
  type: 'code',
  keymap: () => keymaps.toggleCode,
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeLg, null, "`", /*#__PURE__*/React.createElement(FormattedMessage, advancedTextFormattingMessages.code), "`"))
}, {
...
const imageAutoFormat = {
  name: 'Image',
  type: 'image',
  autoFormatting: () => /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement(CodeLg, null, "![", /*#__PURE__*/React.createElement(FormattedMessage, messages.altText), "](http://www.image.com)"))
};
...
export const getComponentFromKeymap = keymap => {
  ...
  return /*#__PURE__*/React.createElement("span", null, keyParts.map((part, index) => {
    if (part === '+') {
      return /*#__PURE__*/React.createElement("span", {
        key: `${shortcut}-${index}`
      }, ' + ');
    } else if (part === 'Cmd') {
      return /*#__PURE__*/React.createElement(CodeSm, {
        key: `${shortcut}-${index}`
      }, "\u2318");
    } else if (['ctrl', 'alt', 'opt', 'shift'].indexOf(part.toLowerCase()) >= 0) {
      return /*#__PURE__*/React.createElement(CodeMd, {
        key: `${shortcut}-${index}`
      }, part);
    }
...
}, /*#__PURE__*/React.createElement(FormattedMessage, messages.editorHelp), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(ToolbarButton, {
  onClick: onClose,
...
const ModalFooter = ({
  ...
  showKeyline: showKeyline
}, /*#__PURE__*/React.createElement(FormattedMessage, _extends({}, messages.helpDialogTips, {
  values: {
...
class HelpDialog extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(ModalTransition, null, this.props.isVisible ? /*#__PURE__*/React.createElement(AkModalDialog, {
      width: "large",
    ...
    }, /*#__PURE__*/React.createElement(ContentWrapper, null, /*#__PURE__*/React.createElement(Line, null), /*#__PURE__*/React.createElement(Content, null, /*#__PURE__*/React.createElement(ColumnLeft, null, /*#__PURE__*/React.createElement(Title, null, /*#__PURE__*/React.createElement(FormattedMessage, messages.keyboardShortcuts)), /*#__PURE__*/React.createElement("div", null, this.formatting.filter(form => {
      const keymap = form.keymap && form.keymap(this.props);
      return keymap && keymap[browser.mac ? 'mac' : 'windows'];
    }).map(form => /*#__PURE__*/React.createElement(Row, {
      key: `textFormatting-${form.name}`
    }, /*#__PURE__*/React.createElement("span", null, form.name), getComponentFromKeymap(form.keymap()))), this.formatting.filter(form => shortcutNamesWithoutKeymap.indexOf(form.type) !== -1).filter(form => form.autoFormatting).map(form => /*#__PURE__*/React.createElement(Row, {
      key: `autoFormatting-${form.name}`
    }, /*#__PURE__*/React.createElement("span", null, form.name), form.autoFormatting())))), /*#__PURE__*/React.createElement(Line, null), /*#__PURE__*/React.createElement(ColumnRight, null, /*#__PURE__*/React.createElement(Title, null, /*#__PURE__*/React.createElement(FormattedMessage, messages.markdown)), /*#__PURE__*/React.createElement("div", null, this.formatting.filter(form => shortcutNamesWithoutKeymap.indexOf(form.type) === -1).map(form => form.autoFormatting && /*#__PURE__*/React.createElement(Row, {
      key: `autoFormatting-${form.name}`
    }, /*#__PURE__*/React.createElement("span", null, form.name), form.autoFormatting()))))))) : null);
  }
