...
export default class Dropdown extends Component {
  render() {
    ...
    }, /*#__PURE__*/React.createElement(MenuContainer, null, items.filter(item => !item.hidden).map((item, idx) => /*#__PURE__*/React.createElement(Item, {
      key: idx,
      isCompact: true,
  ...
  renderSelected(item) {
    ...
    if (selected !== undefined) {
      return selected ? /*#__PURE__*/React.createElement(EditorDoneIcon, {
        primaryColor: B400,
        size: "small",
        label: "test question"
