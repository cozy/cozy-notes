export declare type TTITracking = {
    /**
...
export declare type TransactionTracking = {
    /**
...
export declare type UITracking = {
    /**
...
export declare type NodeViewTracking = {
    /**
...
export declare type BFreezeTracking = {
    enabled?: boolean;
    /**
...
export declare type ProseMirrorRenderedTracking = {
    enabled?: boolean;
    /**
...
export declare type PerformanceTracking = {
    /**
