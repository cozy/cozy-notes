...
import { CollabEventTelepointerData as TelepointerData, CollabParticipant as Participant } from '@atlaskit/editor-common';
export type { CollabEvent, CollabEventData, CollabEditProvider, } from '@atlaskit/editor-common';
