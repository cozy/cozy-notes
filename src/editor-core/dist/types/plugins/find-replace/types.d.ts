...
export declare const findReplacePluginKey: PluginKey<any, any>;
...
export declare type TextGrouping = {
    /** The concatenated text across nodes */
    text: string;
    /** Start position */
    pos: number;
} | null;
export declare type FindReplaceOptions = {
    allowMatchCase?: boolean;
};
export declare type MatchCaseProps = {
    allowMatchCase?: boolean;
    shouldMatchCase?: boolean;
