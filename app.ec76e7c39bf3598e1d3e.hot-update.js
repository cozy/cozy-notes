...
var Form = function Form(props) {
  ...
  var onTitleChange = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (e) {
    ...
    if (title != note.title) {
      ...
      console.log("save title", title, "with content", content);
      setNote(newNote);
  ...
  var onContentChange = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(function (editorView) {
    ...
    if (content != note.content) {
      ...
      console.log("save content", content, "with title", title);
      setNote(newNote);
      window.setTimeout(function () {
        return save(newNote);
      });
...
//# sourceMappingURL=app.ec76e7c39bf3598e1d3e.hot-update.js.map